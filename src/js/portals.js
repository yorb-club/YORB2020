...
const yorbletReference = [
    ...
    {url: 'https://yorblet1.itp.io', model: PortalModels['sphYellow'], label: {text:"   Go to\nGallery 1", color:0xf4d010, size:1, rotateY:0, xOff:-3, yOff:10, zOff:0}},
    {url: 'https://yorblet2.itp.io', model: PortalModels['sphPink'], label: {text:"   Go to\nGallery 2", color:0xfc3691, size:1, rotateY:0, xOff:-3, yOff:10, zOff:0}},
