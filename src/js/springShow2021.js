...
class LazyRiver {
    ...
    findClosestPointAlongLazyRiver(currentPos) {
        ...
        for (let i = 0; i < this.pointsAlongLazyRiver.length; i++) {
            ...
            let distSquared = currentPos == undefined ? this.camera.position.distanceToSquared(pt) : currentPos.distanceToSquared(pt);
    ...
    loadRiverDecals(modelPath, position) {
        this.riverDecalsLoader.load(
            ...
            (gltf) => {
                ...
                decalScene.scale.set(0.1, 0.1, 0.1);
